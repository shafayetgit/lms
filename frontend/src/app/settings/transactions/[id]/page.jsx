...
export default function TransactionDetailPage() {
  ...
  const transactionId =
    paymentData?.payment_id || paymentData?.public_id?.substring(0, 8) || "Details"
        ...
        <Box sx={{ width: "100%", maxWidth: "800px", mb: 4 }}>
          <Box py={2}>
            <Stack direction="row" justifyContent="space-between" alignItems="flex-start" mb={2}>
              ...
              <Chip
                ...
                sx={{
                  ...
                  fontWeight: 600,
                  px: 1,
                  bgcolor: paymentData?.status === "Completed" ? "success.lighter" : undefined,
                  color: paymentData?.status === "Completed" ? "success.dark" : undefined,
                }}
              />
            </Stack>
            <Stack direction="row" spacing={4} mt={1}>
              ...
              <Box>
                ...
                <Typography variant="body2" fontWeight={500}>
                  {paymentData?.item_details?.title ||
          ...
          <Box py={2.5}>
            ...
            <Stack direction="row" spacing={2} alignItems="center" mb={2.5}>
              <Avatar
                sx={{ bgcolor: "primary.lighter", color: "primary.main", fontWeight: "bold" }}
              >
                {(() => {
            ...
            {(paymentData?.billing_address_line_1 ||
              paymentData?.billing_city ||
              ...
              <Box mt={3}>
                ...
                <Typography variant="body2" fontWeight={500}>
                  {[
                    paymentData.billing_address_line_1,
                    paymentData.billing_address_line_2,
                    paymentData.billing_city,
                    paymentData.billing_state,
                    paymentData.billing_country,
                    paymentData.billing_postal_code,
                  ]
                    .filter(Boolean)
                    .join(", ")}
                </Typography>
            ...
            <Stack spacing={2.5}>
              ...
              <Stack direction="row" justifyContent="space-between">
                ...
                <Typography variant="body1" fontWeight={600} color="success.main">
                  {paymentData?.discount_amount > 0 ? "-" : ""} {paymentData?.currency}{" "}
