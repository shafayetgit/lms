...
import { Box, Card, CardContent, Typography, CardActionArea, alpha } from "@mui/material"
        ...
        <Link href={`${ROUTES.portal.courses.path}?category=${category.slug}`}>
          <Card
            ...
            sx={{
              ...
              boxShadow: theme => `0 4px 12px ${alpha(theme.palette.text.primary, 0.02)}`,
              transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
              "&:hover": {
                borderColor: theme => alpha(theme.palette.text.primary, 0.2),
                boxShadow: theme => `0 15px 35px ${alpha(theme.palette.text.primary, 0.08)}`,
