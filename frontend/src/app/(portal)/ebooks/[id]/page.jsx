...
const ebooks = [
  {
    ...
    reviews: 128,
    image:
      "https://images.unsplash.com/photo-1544947950-fa07a98d237f?auto=format&fit=crop&q=40&w=400",
    category: "Architecture",
    languages: ["English", "Spanish"],
    pages: 342,
    lastUpdated: "March 2024",
    description:
      "Master the art of building scalable, premium React applications with advanced design patterns. This comprehensive guide covers everything from state management to performance optimization in large-scale Next.js environments.",
    longDescription:
...
export default function EbookDetailPage() {
  ...
  return (
    <Box sx={{ py: { xs: 4, md: 8 }, minHeight: "100vh" }}>
        ...
        <Grid container spacing={{ xs: 4, md: 8 }}>
                  ...
                  <Stack direction="row" spacing={1.5} alignItems="flex-start">
                    ...
                    <Box>
                      ...
                      <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.6 }}>
                        Unlock PDF, EPUB, and MOBI formats immediately after secure checkout.
                        Compatible with Kindle and Apple Books.
                      </Typography>
                    </Box>
                  </Stack>
                </Box>
          ...
          <Grid size={{ xs: 12, md: 7 }}>
            ...
            >
              ...
              <Typography
                variant="h6"
                sx={{ color: "text.secondary", fontWeight: 500, mb: 4, lineHeight: 1.6 }}
              >
                {book.description}
              </Typography>
                    ...
                    {tabValue === 2 && (
                      ...
                      >
                        ...
                        <Typography color="text.secondary" sx={{ lineHeight: 1.8 }}>
                          Marcus Aurelius is a world-renowned software architect and design expert
                          with over 15 years of experience in the industry. He has led engineering
                          teams at Fortune 500 companies and is a frequent speaker at major tech
      ...
      >
        <AppBar
          sx={{ position: "relative", bgcolor: "primary.main", color: "primary.contrastText" }}
        >
          <Toolbar>
            <IconButton
              edge="start"
            ...
            <Stack spacing={4}>
              {[1, 2, 3].map(page => (
                ...
                >
                  ...
                  <Box sx={{ mb: 6 }}>
                    <Typography
                      variant="overline"
                      sx={{ fontWeight: 800, color: "secondary.main", letterSpacing: 2 }}
                    >
                  ...
                  <Typography
                    sx={{ lineHeight: 2, fontSize: "1.1rem", color: "text.secondary", mb: 4 }}
                  >
                    Experience the future of web development. In this chapter, we explore the
                    foundational principles that separate average frontend engineers from elite
                    architects. We&apos;ll dive deep into modularity, state management, and the
                    emotional resonance of modern UI design.
                  </Typography>
                  <Typography
                    sx={{ lineHeight: 2, fontSize: "1.1rem", color: "text.secondary", mb: 4 }}
                  >
                    The key to building a scalable system is to think beyond the immediate
                    requirements. We must design for the unknown. This means creating components
                    that are not just reusable, but extensible. We&apos;ll look at how to leverage
                    React&apos;s latest features to achieve this at scale without sacrificing
                    performance.
                  </Typography>
                  ...
                  >
                    ...
                    <Typography variant="body1" sx={{ fontStyle: "italic", color: "text.primary" }}>
                      &quot;A well-architected system is one where the cost of change remains low
                      throughout the lifetime of the project.&quot;
                    </Typography>
                  </Box>

                  <Typography sx={{ lineHeight: 2, fontSize: "1.1rem", color: "text.secondary" }}>
                    As we progress through these pages, keep in mind that these patterns are not
                    dogma. They are tools in your belt. The elite engineer knows when to follow the
                    rules, and when the requirements demand a more creative approach.
                  </Typography>
              ...
              <Box sx={{ py: 10, textAlign: "center" }}>
                ...
                <Typography sx={{ mb: 4, color: "text.secondary", maxWidth: 500, mx: "auto" }}>
                  Purchase the full version to unlock all {book.pages} pages of architectural
                  mastery and private resource files.
                </Typography>
                <Button
                  variant="contained"
                  color="secondary"
