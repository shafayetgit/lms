        ...
        <Box sx={{ mb: 10, textAlign: "left" }}>
          ...
          >
            ...
            <Typography variant="h6" color="text.secondary" sx={{ fontWeight: 400, mb: 4 }}>
              At EcoFin Institute, your data privacy is our absolute priority. We take rigor and
              transparency seriously, ensuring your learning journey is secure.
            </Typography>
            <Typography
              variant="caption"
              sx={{
        ...
        <Stack spacing={6}>
          <Box>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 2, mb: 2 }}>
              We collect personal information such as your name, email address, and billing details
              when you register for courses or purchase e-books. This is strictly used for
              personalized education and transactional integrity.
            </Typography>
            <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 2 }}>
              Additionally, we monitor technical data like device type and browser to optimize your
              learning experience on EcoFin platform.
            </Typography>
          </Box>
          ...
          <Box>
            ...
            <Box
              component="ul"
              sx={{ color: "text.secondary", pl: 3, "& li": { mb: 2, lineHeight: 2 } }}
            >
          ...
          <Box>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 2, mb: 2 }}>
              EcoFin Institute utilizes industry-standard encryption (SSL/TLS) for all transactions
              and user-data storage. Your financial information is never stored on our servers; it
              is handled by our PCI-compliant partners (Stripe/PayPal).
            </Typography>
          </Box>
        </Stack>
      </Container>
