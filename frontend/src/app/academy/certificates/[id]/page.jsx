...
import { WorkspacePremium, DownloadOutlined } from "@mui/icons-material"
...
export default function StudentCertificatePage() {
  ...
  const issuerName =
    cert?.template && cert.template !== "Default Template" ? cert.template : "EcoFin Institute"
  const boardName =
    cert?.template && cert.template !== "Default Template"
      ? `${cert.template} Academic Board`
      : "EcoFin Academic Board"
      ...
      <Box sx={{ overflowX: "auto", width: "100%", pb: 2 }}>
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            {settingsData?.certificate_logo ||
            settingsData?.site_logo_light ||
            settingsData?.site_logo_dark ? (
              <Box
                component="img"
                src={
                  (
              ...
              <Grid size={{ xs: 4 }}>
                <Box
                  sx={{
                    ...
                    boxShadow: "0 4px 10px rgba(170,124,17,0.4)",
                    mx: "auto",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                >
                  <WorkspacePremium
                    sx={{ color: "#ffffff", fontSize: { xs: 30, sm: 40, md: 45 } }}
                  />
                </Box>
              </Grid>
          ...
          <Box sx={{ mt: 3, pt: 1, borderTop: "1px solid #e5d9c7", width: "80%" }}>
            <Typography
              variant="caption"
              sx={{ fontFamily: "Outfit, sans-serif", color: "#a08e75", letterSpacing: "0.05em" }}
            >
