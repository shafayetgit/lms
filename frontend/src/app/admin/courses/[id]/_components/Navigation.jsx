...
import { Contacts, Edit, Event, School, Work, Payments, Star } from "@mui/icons-material"
...
export default function Navigation({ serviceType }) {
  ...
  const navigators = [
    { label: "Update", href: `/admin/courses/${id}`, icon: <Edit /> },
    { label: "Modules", href: `/admin/courses/${id}/modules`, icon: <School /> },
    { label: "Reviews", href: `/admin/courses/${id}/reviews`, icon: <Star /> },
  ]
