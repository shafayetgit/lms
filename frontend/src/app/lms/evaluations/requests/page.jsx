...
function RequestsList({ action }) {
  ...
  return <CDataTable columns={columns} rows={data} meta={meta} loading={isLoading}  action={action} />;
}

export default function RequestsPage() {
  const navigators = [
    { label: "Evaluation Sessions", href: "/lms/evaluations", icon: <SchoolOutlined /> },
    { label: "Certificate Requests", href: "/lms/evaluations/requests", icon: <AssignmentTurnedInOutlined /> },
  ];
    ...
    tips: [
      {
        ...
        description: "Sessions represent scheduled online/practical evaluations for students by their assigned instructor.",
      },
      {
        title: "Certificate Requests",
        description: "Students submit certificate requests upon batch/course completion. Approving them schedules a new evaluation session.",
      },
    ],
  };
