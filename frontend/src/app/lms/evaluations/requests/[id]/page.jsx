  ...
  return (
    <CModuleLayout helpTips={helpTips}>
      <Box sx={{ bgcolor: "background.paper", p: 3, borderRadius: 1, boxShadow: 1 }}>
        <Typography variant="h5" mb={1} fontWeight="600">Certificate Request Details</Typography>
        
        {request && (
          <Box sx={{ mb: 4, p: 2, bgcolor: "action.hover", borderRadius: 1 }}>
            <Typography variant="body1" mb={0.5}>
              <strong>Student:</strong> {request.member?.full_name || request.member?.email || "N/A"}
            </Typography>
            <Typography variant="body1" mb={0.5}>
              <strong>Course/Batch:</strong> {request.course?.title || request.batch?.title || "N/A"}
            </Typography>
            <Typography variant="body1" mb={0.5}>
