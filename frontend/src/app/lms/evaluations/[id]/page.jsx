...
import { useReadEvaluationQuery, useGradeEvaluationMutation } from "@/features/certificate/certificateApi";
...
export default function EvaluationDetailPage() {
  ...
  const { data: instructorsRes, isLoading: isInstructorsLoading } = useReadInstructorsQuery({ size: 100 });
  ...
  const navigators = [
    { label: "Details", href: `/lms/evaluations/${id}`, icon: <InfoOutlined /> },
  ];
  ...
  const helpTips = {
    ...
    tips: [
      ...
      },
      {
        ...
        description: "If marked Pass, a certificate is automatically generated and published for the student.",
      },
      {
        title: "Fail → No Certificate",
        description: "If marked Fail, no certificate is issued. The student may re-request when ready.",
      },
      {
        title: "Feedback",
        description: "Provide constructive written feedback — reference topics the student struggled with to help them improve.",
      },
    ],
  };
