...
export default function CreateDialog() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm, setErrors }) => {
      ...
      try {
        ...
        // null out fields that don't apply to the selected type
        if (createPayload.lesson_type !== "video") {
          createPayload.youtube = null
          createPayload.body = null
          createPayload.duration = null
        }
        if (createPayload.lesson_type !== "content") {
          createPayload.content = null
        }
        if (createPayload.lesson_type !== "quiz") {
          createPayload.quiz_id = null
        }
        if (createPayload.lesson_type !== "assignment") {
          createPayload.assignment_id = null
        }
  ...
  return (
    <PermissionGuard resource="lesson" action="create">
      <CDialog
        title="Create Lesson"
