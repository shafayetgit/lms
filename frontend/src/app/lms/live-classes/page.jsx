...
function LiveClassList({ action }) {
    ...
    },
    {
      ...
      renderCell: (row) => renderCell(
          <Box>
            ...
            <Typography variant="caption" color="textSecondary">{row.time} ({row.duration}m)</Typography>
          </Box>
      ),
    },
    {
  ...
  return <CDataTable columns={columns} rows={data} meta={meta} loading={isLoading}  action={action}  bulkDelete={{ model: "Live Class", invalidateTag: "LIVE_CLASSES" }} />;
}
