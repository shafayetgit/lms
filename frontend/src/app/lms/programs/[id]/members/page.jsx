...
import { useReadProgramQuery, useReadProgramMembersQuery } from "@/features/program/programApi"
import PermissionGuard from "@/components/ui/PermissionGuard"

export default function ProgramMembersPage() {
  const { id } = useParams()

  const { data: { data: programDataObj } = {}, isLoading: isLoadingProgram } = useReadProgramQuery(
    id,
    {
  ...
  const { data: { data: membersList } = {}, isLoading: isLoadingMembers } =
    useReadProgramMembersQuery(id, {
      skip: !id,
    })
