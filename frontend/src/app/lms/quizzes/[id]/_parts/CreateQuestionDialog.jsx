  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm, setErrors }) => {
      try {
        ...
        setErrors(errors);
        toast.error(err?.data?.detail || err?.data?.message || "Failed to add question");
      }
    },
  });
        ...
        <Grid container spacing={2}>
          <Grid size={{ xs: 12 }}>
            <CTextField
              ...
              error={(formik.touched.text || formik.submitCount > 0) && Boolean(formik.errors.text)}
          ...
          <Grid size={{ xs: 6, sm: 3 }}>
            <CNumberField
              ...
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              error={(formik.touched.marks || formik.submitCount > 0) && Boolean(formik.errors.marks)}
          ...
          {isChoiceBased && (
            <Grid size={{ xs: 12 }}>
              <Stack spacing={1.5}>
                ...
                {typeof formik.errors.choices === "string" && (formik.touched.choices || formik.submitCount > 0) && (
