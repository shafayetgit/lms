    ...
    >
      ...
      <CardContent sx={{ p: 4, flexGrow: 1, display: "flex", flexDirection: "column" }}>
        ...
        <Typography
          variant="h6"
          component="h3"
          sx={{ fontWeight: 900, mb: 2, lineHeight: 1.3, color: "primary.main" }}
        >
          {course.title}
        </Typography>
        ...
        <Box sx={{ mt: "auto" }}>
          <Box sx={{ mb: 2 }}>
            <Box sx={{ display: "flex", justifyContent: "space-between", mb: 1 }}>
              <Typography
                variant="caption"
                sx={{ fontWeight: 900, fontSize: "0.65rem", letterSpacing: 0.5 }}
              >
                COURSE PROGRESS
              </Typography>
          ...
          <CButton
            ...
            sx={{
              ...
              boxShadow:
                course.progress > 0
                  ? `0 10px 20px -5px ${alpha(theme.palette.secondary.main, 0.3)}`
                  : "none",
            }}
