...
import { FavoriteBorder, Favorite, MenuBook, AccessTime, ArrowForward } from "@mui/icons-material"
        ...
        >
          <Box>
            ...
            {course.originalPrice && (
              <Typography
                variant="caption"
                sx={{ textDecoration: "line-through", color: "text.disabled", fontWeight: 700 }}
              >
                ${course.originalPrice}
              </Typography>
            )}
