...
export default function CHelpSidebar({ title = "Help & Guidelines", description, tips = [], children }) {
  return (
    <Box 
      sx={{ 
        position: "sticky", 
    ...
    >
      ...
      {tips && tips.length > 0 && (
        <>
          ...
          <Box component="ul" sx={{ pl: 2, m: 0, '& li': { mb: 1, typography: 'body2', color: 'text.secondary' } }}>
            {tips.map((tip, index) => {
