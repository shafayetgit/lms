          ...
          >
            {course.total_lessons > 0 && (
              <Tooltip title="Total Lessons">
                ...
                >
                  ...
                  <Typography
                    variant="body2"
                    sx={{ fontWeight: 500, fontSize: "0.875rem", lineHeight: 1 }}
                  >
            ...
            {(course.featured || course.enable_certification || course.paid_certificate) && (
              <Tooltip title="Certificate Included">
                <WorkspacePremium
                  sx={{ fontSize: 18, color: theme => theme.palette.warning.main }}
                />
              </Tooltip>
            )}
          </Stack>
                  ...
                  {instructors.length === 1
                    ...
                    : instructors.length === 2
                      ...
                      : `${instructors
                          .slice(0, -1)
                          .map(i => i.first_name)
                          .join(", ")} and ${instructors[instructors.length - 1].first_name}`}
                </Typography>
              )}
            </Stack>
              ...
              (course.paid_certificate || course.enable_certification) && (
                <Stack direction="row" alignItems="center" spacing={1}>
                  {certificateId ? (
                    ...
                    <SchoolOutlined
                      sx={{ fontSize: 20, color: theme => theme.palette.text.disabled }}
                    />
                  )}
                </Stack>
              )
