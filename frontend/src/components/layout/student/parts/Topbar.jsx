...
import { DARK_LOGO, LIGHT_LOGO } from "@/lib/constants/app"
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center" }}>
            ...
            <Link href="/" style={{ textDecoration: "none", display: "flex" }}>
              ...
              >
                <Image
                  src={theme.palette.mode === "dark" ? LIGHT_LOGO : DARK_LOGO}
        ...
        slotProps={{
          ...
          paper: {
            sx: {
              ...
              color: "text.primary",
              boxShadow: theme => `-20px 0 50px ${alpha(theme.palette.common.black, 0.5)}`,
            },
          },
        }}
      >
        <Box sx={{ height: "100%", display: "flex", flexDirection: "column" }}>
          ...
          >
            ...
            <IconButton onClick={toggleNotifDrawer(false)} sx={{ color: "text.secondary" }}>
              <CloseIcon />
            </IconButton>
          </Box>
